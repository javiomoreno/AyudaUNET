...
public class Actividadcargarnuevosemestre extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.cargar_nuevo_semestre);
	...
	public void onClickSiguienteMateria(View v) 
	{
		int suma = 0;
		...
		else
		{
			if(porcentaje_4.getText().toString().equals(""))
			{
				...
				if(suma == 100)
				{
					...
					Toast.makeText(this, "La Suma de los porcentajes debe ser igual a 100.!", Toast.LENGTH_SHORT).show();				
			}
			else
			{
	...
	{
		this.finish();
		Intent i = new Intent(this, Actividadcargarnuevosemestre.class );
        startActivity(i);
	}
